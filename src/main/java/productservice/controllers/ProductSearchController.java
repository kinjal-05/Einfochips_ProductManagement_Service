...
import productservice.dtos.ApiResponse;
import productservice.dtos.ProductResponseDTO;
import productservice.services.ProductSearchService;
...
public class ProductSearchController {
	...
	public ResponseEntity<ApiResponse<Page<ProductResponseDTO>>> searchProducts(
		...
		return ResponseEntity.status(HttpStatus.OK)
				.body(ApiResponse.success(response, "Products fetched successfully"));
	}
